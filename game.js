...
function play() {
    if (startM.innerText == "Start Match") {
        ...
        div.style.textShadow = " -1.5px 0 blue, 1.5px 0 blue, 1.5px 0 blue, 0 -1.5px blue";
...
function play2() {
    ...
    div.style.fontSize = "55px";
    div.style.textShadow = " -1.8px 0 black, 1.8px 0 black, 1.8px 0 black, 0 -1.8px black";
    document.querySelector('#balls').textContent = b2;
    document.querySelector('#text').textContent = ' Balls Left';
    game2();
}
        ...
        if (s > -1) {
            ...
            if (balls > 0 && a <= b) {
                ...
                if (balls == 0 && a < b) {
                    ...
                    document.querySelector('body').style.backgroundImage = "url(iim1.gif)";
                    ...
                    div.style.fontSize = "75px";
                    div.style.marginTop = "2px";
                    div.style.textShadow = " -1.5px 0 black, 1.5px 0 black, 1.5px 0 black, 0 -1.5px black";
                }
                else {
                    document.querySelector('#balls').textContent = 'Match';
                    document.querySelector('#text').textContent = ' is Over';
